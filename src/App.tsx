...
export default function App() {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      animatePOV({ lat, lng: lng0, altitude: 1.7 }, 1500, easeInOut)
  ...
  useEffect(() => {
    ...
    const lat = applyScreenLift(lat0)
    globeRef.current?.pointOfView({ lat, lng: lng0, altitude: 1.7 }, 0)
  }, [])
      ...
      <div className="globeStage">
        ...
        <Globe
          ...
          onPolygonClick={(feat: any) => {
            ...
            const lat = applyScreenLift(lat0)
            animatePOV({ lat, lng: lng0, altitude: 1.7 }, 1000, easeInOut)
